...
// ================== Logging ==================
const LOG_API = (process.env.LOG_API || 'true').toLowerCase() !== 'false';
const LOG_TO_FILE =
  (process.env.LOG_TO_FILE || 'true').toLowerCase() === 'true';
const LOG_TO_CONSOLE =
  (process.env.LOG_TO_CONSOLE || 'true').toLowerCase() === 'true';
const LOG_FILE = process.env.LOG_FILE || 'ozon_api.log';
const LOG_REQ_BODY =
  (process.env.LOG_REQ_BODY || 'false').toLowerCase() === 'true';
const LOG_RES_BODY =
  (process.env.LOG_RES_BODY || 'false').toLowerCase() === 'true';
const LOG_MAX_BODY_CHARS = Number(process.env.LOG_MAX_BODY_CHARS || '2000');
